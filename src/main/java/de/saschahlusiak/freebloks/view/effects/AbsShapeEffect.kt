...
abstract class AbsShapeEffect internal constructor(
    ...
    internal constructor(model: ViewModel, turn: Turn) : this(model, turn.shape, model.getPlayerColor(turn.player), turn.x, turn.y, turn.orientation)

...
class LobbyDialogOld: MaterialDialogFragment(R.layout.lobby_dialog_fragment), GameEventObserver, OnItemClickListener, ColorAdapter.EditPlayerNameListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) = with(binding) {
        ...
        colorAdapter = ColorAdapter(this@LobbyDialogOld, requireContext(), client.game, null)
        colorGrid.apply {
            adapter = colorAdapter
            onItemClickListener = this@LobbyDialogOld
        }
        ...
        client.addObserver(this@LobbyDialogOld)
    }
    ...
    companion object {
        private val TAG = LobbyDialogOld::class.simpleName
    }
}